...
const NavBar = () => { 
const {cartTotalQquantity} = useSelector( state => state.cart)
    return (
                        ...
                        <Link to='/cart'>
                            <li class="relative py-2">
                                <div class="t-0 absolute left-3">
                                    <p class="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-3 text-xs text-white">{cartTotalQquantity}</p>
                                </div>
